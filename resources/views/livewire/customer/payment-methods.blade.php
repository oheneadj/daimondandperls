        ...
        <div class="bg-white border border-base-content/10 rounded-2xl p-6 md:p-10 shadow-sm mb-8 animate-in fade-in slide-in-from-top-4 duration-300">
            ...
            <form wire:submit="save" class="space-y-8 max-w-2xl">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    @if(strlen($accountNumber) === 10 && $provider && !$this->isMomoFormValid)
                        <p class="text-xs text-error flex items-center gap-1 -mt-2">
                            <span>⚠</span> This number doesn't match {{ match($provider) { '13' => 'MTN', '6' => 'Telecel', '7' => 'AT', default => 'the selected network' } }}. Expected: {{ $this->momoPlaceholder }}
                        </p>
                    @endif
