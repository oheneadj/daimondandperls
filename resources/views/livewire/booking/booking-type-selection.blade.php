    ...
    <div class="container mx-auto max-w-4xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            ...
            <button
                ...
                class="group relative bg-base-100 border-2 border-base-content/10 hover:border-primary rounded-[28px] p-8 lg:p-10 text-left transition-all duration-300 hover:shadow-xl hover:shadow-primary/5 hover:-translate-y-1 focus:outline-none focus:ring-4 focus:ring-primary/20"
            >
                ...
                <p class="text-[14px] text-base-content/50 font-medium leading-relaxed mb-6">
                    {{ __('Order your selected food packages for delivery or pickup. Pay online and get it sorted quickly.') }}
                </p>

                <div class="flex items-center gap-2 text-[11px] font-bold text-primary uppercase tracking-widest">
            ...
            <button
                ...
                class="group relative bg-base-100 border-2 border-base-content/10 hover:border-accent rounded-[28px] p-8 lg:p-10 text-left transition-all duration-300 hover:shadow-xl hover:shadow-accent/5 hover:-translate-y-1 focus:outline-none focus:ring-4 focus:ring-accent/20"
            >
                <div class="absolute top-6 right-6 size-10 rounded-full bg-accent/10 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-5 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                    </svg>
                </div>

                <div class="size-16 rounded-2xl bg-accent/10 flex items-center justify-center mb-6 group-hover:bg-accent/20 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-8 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5" />
                    </svg>
                </div>

                <h3 class="text-2xl font-bold text-base-content mb-3 group-hover:text-accent transition-colors">
                    {{ __('Event Catering') }}
                </h3>
                <p class="text-[14px] text-base-content/50 font-medium leading-relaxed mb-6">
                ...
                <div class="flex items-center gap-2 text-[11px] font-bold text-accent uppercase tracking-widest">
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.764 9.764 0 01-2.555-.337A5.972 5.972 0 015.41 20.97a5.969 5.969 0 01-.474-.065 4.48 4.48 0 00.978-2.025c.09-.457-.133-.901-.467-1.226C3.93 16.178 3 14.189 3 12c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25z" />
                    </svg>
                    {{ __('Get a custom quote') }}
                </div>
            </button>
        </div>
