        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div class="lg:col-span-7">
                <div class="bg-base-100 border border-base-content/10 rounded-[24px] p-5 sm:p-8 lg:p-12 shadow-sm">
                    ...
                    {{-- ══ STEP 2: Menu Suggestions + Pax/Buffet ══ --}}
                    ...
                    @elseif($currentStep === 4)
                        <div wire:key="step-summary" class="animate-fade-in space-y-8">
                            ...
                            <div class="bg-base-200 rounded-2xl p-6 lg:p-8 space-y-6 border border-base-content/10">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div>
                                        ...
                                        @if($pax)
                                            <div class="text-[13px] text-base-content/60 font-medium mt-1">
                                                {{ $pax }} {{ $is_buffet ? 'guests (buffet)' : 'plates' }}
                                            </div>
                                        @endif
                                    </div>
                                    <div>
                            ...
                            <div class="bg-primary/5 border border-primary/20 rounded-2xl p-5 flex items-start gap-4">
                                ...
                                <div>
                                    <div class="text-[13px] font-bold text-primary uppercase tracking-wide">Quote Pending</div>
                                    <p class="text-[12px] text-base-content/60 font-medium leading-relaxed mt-1">
                                        Your event booking will be submitted as an inquiry. Our team will review your menu selections and contact you with a detailed quote.
                                    </p>
                                </div>
                            </div>
            ...
            <!-- Sidebar -->
            <x-booking.order-summary :cartItems="$cartItems" :cartTotal="$cartTotal" :isEvent="true" />
        </div>
    </div>
</div>
