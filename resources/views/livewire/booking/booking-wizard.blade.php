                ...
                <div class="bg-base-100 border border-base-content/10 rounded-lg p-5 sm:p-8 lg:p-10 shadow-dp-lg">
                    ...
                    @if($currentStep === 1)
                        <div wire:key="step-review" class="animate-fade-in space-y-8">
                            <div>
                                <h2 class="text-xl font-semibold text-base-content mb-2 text-center sm:text-left">Review Selection</h2>
                                <p class="text-[14px] text-base-content/50 font-medium text-center sm:text-left">Review your chosen packages and quantities before proceeding.</p>
                            </div>

                            <div class="space-y-4">
                                @foreach($cartItems as $item)
                                    <div wire:key="cart-review-{{ $item['package']->id }}" class="flex items-center gap-5 p-4 bg-base-200 rounded-lg border border-base-content/10 group transition-all hover:bg-base-100 hover:shadow-sm">
                                        <div class="flex-1">
                                            <h4 class="text-[15px] font-semibold text-base-content mb-1">{{ $item['package']->name }}</h4>
                    ...
                    @elseif($currentStep === 2)
                        <div wire:key="step-contact" class="animate-fade-in space-y-8">
                            <div>
                                ...
                                <p class="text-[14px] text-base-content/50 font-medium">Enter your information so we can coordinate your catering experience.</p>
                            </div>
                    ...
                    @elseif($currentStep === 3)
                        <div wire:key="step-summary" class="animate-fade-in space-y-8">
                            <div>
                                <h2 class="text-xl font-semibold text-base-content mb-2">Final Summary</h2>
                                <p class="text-[14px] text-base-content/50 font-medium">Verify all details before proceeding to secure payment.</p>
                            </div>
                            ...
                            <div class="bg-success/5 border border-success/15 rounded-lg p-5 flex items-start gap-4">
                                ...
                                <div>
                                    <div class="text-[13px] font-semibold text-success">Ready for confirmation</div>
                                    <p class="text-xs text-success/80 font-medium leading-relaxed">By clicking finalize, you agree to our catering terms. A booking reference will be generated for your payment.</p>
                                </div>
                            </div>
