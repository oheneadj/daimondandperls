    ...
    <div class="relative" @if($isPassword) x-data="{ show: false }" @endif>
        ...
        @elseif($isPassword)
            ...
            <button type="button" @click="show = !show" tabindex="-1"
                class="absolute top-0 right-0 h-full flex items-center px-3 text-base-content/40 hover:text-base-content/70 transition-colors">
                ...
                <svg x-show="show" x-cloak xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
