...
<body class="min-h-screen bg-[#F4F4F6] antialiased relative overflow-x-hidden">
    ...
    <div class="relative z-10 flex min-h-svh flex-col items-center justify-center p-6 md:p-10">
        <div class="flex w-full {{ $maxWidth ?? 'max-w-[440px]' }} flex-col gap-10">
            ...
            <div class="bg-white rounded-[40px] border border-base-content/5 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] overflow-hidden backdrop-blur-sm">
