@php
    $navGroups = [
        ...
        'STAFF' => [
            ['label' => 'Admins & Staff', 'route' => 'admin.users.index', 'icon' => 'user-group'],
            ['label' => 'Roles & Perms', 'route' => 'admin.roles.index', 'icon' => 'shield-check'],
        ],
        'SYSTEM' => [
            ['label' => 'Reports', 'route' => 'admin.reports.index', 'icon' => 'chart-bar-square'],
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <div class="flex flex-col overflow-hidden">
                    ...
                    <span class=" text-[11px] text-white/40 leading-none">Administrator</span>
                </div>
            </div>
