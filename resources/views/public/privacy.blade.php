            ...
            <div class="max-w-4xl mx-auto bg-base-100 p-8 lg:p-16 rounded-[40px] border border-base-content/10 shadow-xl">
                ...
                <div class="bg-base-200 p-6 rounded-2xl mt-10">
                    ...
                    <ol class="space-y-2.5">
                        <li><a href="#privacy-1" class="text-[14px] text-primary font-semibold hover:underline underline-offset-4">1. Information Collection</a></li>
                        <li><a href="#privacy-2" class="text-[14px] text-primary font-semibold hover:underline underline-offset-4">2. Data Usage</a></li>
                        <li><a href="#privacy-3" class="text-[14px] text-primary font-semibold hover:underline underline-offset-4">3. Information Protection</a></li>
                        <li><a href="#privacy-4" class="text-[14px] text-primary font-semibold hover:underline underline-offset-4">4. Cookies & Analytics</a></li>
                        <li><a href="#privacy-5" class="text-[14px] text-primary font-semibold hover:underline underline-offset-4">5. Policy Updates</a></li>
                    </ol>
                </div>
                ...
                <div class="mt-10 space-y-0">
                    ...
                    {{-- Section 1 --}}
                    <section id="privacy-1" class="scroll-mt-24 py-10 border-b border-base-content/5">
                    ...
                    {{-- Section 2 --}}
                    <section id="privacy-2" class="scroll-mt-24 py-10 border-b border-base-content/5">
                        <div class="flex items-center gap-3 mb-4">
                    ...
                    {{-- Section 3 --}}
                    <section id="privacy-3" class="scroll-mt-24 py-10 border-b border-base-content/5">
                        <div class="flex items-center gap-3 mb-4">
                    ...
                    {{-- Section 4 --}}
                    <section id="privacy-4" class="scroll-mt-24 py-10 border-b border-base-content/5">
                        <div class="flex items-center gap-3 mb-4">
                    ...
                    {{-- Section 5 --}}
                    <section id="privacy-5" class="scroll-mt-24 py-10">
                        <div class="flex items-center gap-3 mb-4">
