<x-guest-layout title="Terms of Service">
    ...
    <div class="bg-base-200 min-h-screen py-20 lg:py-32">
        <div class="container mx-auto px-4 lg:px-8">
            <div class="max-w-4xl mx-auto bg-base-100 p-8 lg:p-16 rounded-[40px] border border-base-content/10 shadow-xl">

                {{-- Header --}}
                <div class="inline-flex items-center gap-2 bg-base-200 text-base-content/50 text-[11px] font-bold px-4 py-2 rounded-full uppercase tracking-widest mb-6">
                    Legal
                </div>
                ...
                <div class="border-b border-base-content/10 mt-10"></div>

                {{-- Table of Contents --}}
                <div class="bg-base-200 p-6 rounded-2xl mt-10">
                    <div class="text-[11px] font-bold uppercase tracking-[0.2em] text-base-content/40 mb-4">In This Document</div>
                    <ol class="space-y-2.5">
                        <li><a href="#section-1" class="text-[14px] text-primary font-semibold hover:underline underline-offset-4">1. Agreement to Terms</a></li>
                        <li><a href="#section-2" class="text-[14px] text-primary font-semibold hover:underline underline-offset-4">2. Booking & Reservations</a></li>
                        <li><a href="#section-3" class="text-[14px] text-primary font-semibold hover:underline underline-offset-4">3. Cancellation Policy</a></li>
                        <li><a href="#section-4" class="text-[14px] text-primary font-semibold hover:underline underline-offset-4">4. Service Delivery</a></li>
                        <li><a href="#section-5" class="text-[14px] text-primary font-semibold hover:underline underline-offset-4">5. Governing Law</a></li>
                    </ol>
                </div>
                ...
                <div class="mt-10 space-y-0">
                    ...
                    {{-- Section 1 --}}
                    <section id="section-1" class="scroll-mt-24 py-10 border-b border-base-content/5">
                        <div class="flex items-center gap-3 mb-4">
                            <div class="size-8 bg-primary/5 rounded-lg flex items-center justify-center text-primary text-[13px] font-bold shrink-0">1</div>
                    ...
                    {{-- Section 2 --}}
                    <section id="section-2" class="scroll-mt-24 py-10 border-b border-base-content/5">
                        <div class="flex items-center gap-3 mb-4">
                            <div class="size-8 bg-primary/5 rounded-lg flex items-center justify-center text-primary text-[13px] font-bold shrink-0">2</div>
                    ...
                    {{-- Section 3 --}}
                    <section id="section-3" class="scroll-mt-24 py-10 border-b border-base-content/5">
                        <div class="flex items-center gap-3 mb-4">
                            <div class="size-8 bg-primary/5 rounded-lg flex items-center justify-center text-primary text-[13px] font-bold shrink-0">3</div>
                            <h2 class="text-xl font-bold text-base-content">Cancellation Policy</h2>
                        </div>
                        <ul class="list-disc pl-5 space-y-3 text-[15px] text-base-content/60 font-medium leading-relaxed">
                    ...
                    {{-- Section 4 --}}
                    <section id="section-4" class="scroll-mt-24 py-10 border-b border-base-content/5">
                        <div class="flex items-center gap-3 mb-4">
                            <div class="size-8 bg-primary/5 rounded-lg flex items-center justify-center text-primary text-[13px] font-bold shrink-0">4</div>
                    ...
                    {{-- Section 5 --}}
                    <section id="section-5" class="scroll-mt-24 py-10">
                        <div class="flex items-center gap-3 mb-4">
                            <div class="size-8 bg-primary/5 rounded-lg flex items-center justify-center text-primary text-[13px] font-bold shrink-0">5</div>
                ...
                {{-- Bottom CTA --}}
                <div class="border-t border-base-content/10 mt-4 pt-10 text-center">
