<x-guest-layout title="Contact Us">
    ...
    {{-- Hero --}}
    <x-ui.page-hero badge="Get in Touch" title="Let's Plan Something<br class='hidden sm:block'> Extraordinary"
            ...
            <div class="max-w-5xl mx-auto grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
                ...
                <div class="lg:col-span-5 space-y-6">
                    ...
                    <div class="bg-base-200 rounded-2xl p-8 space-y-6">
                        <h2 class="text-[13px] font-bold text-base-content/40 uppercase tracking-widest">Contact Details
                        </h2>

                        <a href="https://maps.google.com/?q=Accra+Ghana" target="_blank"
                            ...
                            <div>
                                <p class="text-[12px] font-bold text-base-content/40 uppercase tracking-widest mb-0.5">
                                    Address</p>
                                <p
                                    class="text-[14px] font-semibold text-base-content group-hover:text-primary transition-colors leading-snug">
                                    Diamond & Pearls Kitchen, Gbawe, Accra, Ghana</p>
                            </div>
                        </a>
                        ...
                        <a href="tel:+233244203181" class="flex items-start gap-4 group">
                            <div class="size-11 bg-[#18542A]/10 rounded-xl flex items-center justify-center shrink-0">
                                <svg xmlns="http://www.w3.org/2000/svg" class="size-5 text-[#18542A]" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div>
                                <p class="text-[12px] font-bold text-base-content/40 uppercase tracking-widest mb-0.5">
                                    Phone</p>
                                <p
                                    class="text-[14px] font-semibold text-base-content group-hover:text-[#18542A] transition-colors">
                                    +233 244 203 181</p>
                            </div>
                        </a>
                        ...
                        <a href="mailto:graceayesu@yahoo.com" class="flex items-start gap-4 group">
                            <div class="size-11 bg-accent/15 rounded-xl flex items-center justify-center shrink-0">
                                <svg xmlns="http://www.w3.org/2000/svg" class="size-5 text-amber-600" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div>
                                <p class="text-[12px] font-bold text-base-content/40 uppercase tracking-widest mb-0.5">
                                    Email</p>
                                <p
                                    class="text-[14px] font-semibold text-base-content group-hover:text-amber-600 transition-colors">
                                    info@diamondsandpearlsgh.com</p>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="bg-[#18542A] p-8 rounded-2xl text-white space-y-4 shadow-lg relative overflow-hidden">
                        <div class="absolute top-0 right-0 size-32 bg-white/5 rounded-full -translate-y-1/2 translate-x-1/2"
                            aria-hidden="true"></div>
                        <h3 class="text-[13px] font-bold uppercase tracking-widest text-white/60">Working Hours</h3>
                        <div class="space-y-3 text-[14px] font-medium relative z-10">
                            <div class="flex justify-between items-center">
                                <span class="text-white/70">Wednesday</span>
                                <span class="font-bold text-white bg-white/10 px-3 py-1 rounded-lg text-[13px]">9:30 AM
                                    — 4:00 PM</span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-white/70">Friday</span>
                                <span class="font-bold text-white bg-white/10 px-3 py-1 rounded-lg text-[13px]">9:30 AM
                                    — 4:00 PM</span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-white/70">Saturday</span>
                                <span class="font-bold text-white bg-white/10 px-3 py-1 rounded-lg text-[13px]">8:00 AM
                                    — 12:00 PM</span>
                            </div>
                    ...
                    <a href="https://wa.me/{{ $whatsappNumber }}" target="_blank"
                        ...
                        <div
                            class="size-12 bg-[#25D366] rounded-xl flex items-center justify-center shrink-0 shadow-md">
                        ...
                        <div>
                            <p
                                class="text-[14px] font-bold text-base-content group-hover:text-[#25D366] transition-colors">
                                Chat on WhatsApp</p>
                            <p class="text-[12px] text-base-content/50 font-medium">Instant replies during inquiry hours
                            </p>
                        </div>
                        <svg class="size-4 text-base-content/20 ml-auto group-hover:text-[#25D366] transition-colors"
                ...
                <div class="lg:col-span-7 bg-base-100 p-8 lg:p-10 rounded-2xl shadow-xl ring-1 ring-base-content/5">
                    <div class="mb-8">
                        <div
                            class="inline-flex items-center gap-2 bg-primary/10 text-primary text-[11px] font-bold px-3 py-1.5 rounded-full uppercase tracking-widest mb-4">
                            <span class="size-1.5 rounded-full bg-primary animate-pulse"></span>
                            Send a Message
                        </div>
                        <h2 class="text-2xl font-bold text-base-content mb-1">How Can We Help?</h2>
                        <p class="text-[14px] text-base-content/50 font-medium">Fill in the details below and we'll be
                            in touch shortly.</p>
                    </div>
