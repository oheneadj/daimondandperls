...
- `ui-design-system` — Enforces the application's established UI design tokens and component patterns. MUST be activated whenever creating or modifying Blade views, forms, modals, cards, buttons, inputs, alerts, or any visual elements. Defines the canonical styles for inputs, buttons, labels, errors, cards, modals, headings, and badges. Consult before writing any new UI code.
